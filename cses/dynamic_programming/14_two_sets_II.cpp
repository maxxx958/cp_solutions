...
void solve(){
	...
	cout << ways[n * (n + 1) / 4] * power(2, mod - 2) % mod << endl;
	// can't just divide by 2 XD
	// we need to multiply by the modular inverse of 2,
	// becaue the whole thing is in modular arithmetic
}
